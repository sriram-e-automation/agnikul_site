    ...
    <div className="body">
      ...
      <div className="container-fluid custom-form career__form">
        ...
        <div style={{ width: "100%" }}>
          ...
          >
            {[
              { id: "elec", label: "Electrical & Electronics Crew" },
              { id: "sw", label: "Software Crew" },
              { id: "sws", label: "Structural Systems Crew" },
              { id: "fls", label: "Fluid Systems Crew" },
              { id: "op", label: "Operations Crew" },
              { id: "lase", label: "Launch Services Crew" },
              { id: "fiac", label: "Finance and Accounting Crew" },
              { id: "hr", label: "Human Resources Crew" },
            ].map((crew, index, array) => (
              <React.Fragment key={crew.id}>
                <Typography variant="h6" sx={{ color: "#4d8c52" }} id={crew.id}>
                  {crew.label}
                </Typography>
                {index < array.length - 1 && (
                  <Box
                    component="span"
                    sx={{
                      display: { xs: "none", sm: "inline" }, // Show only on screens 600px and wider
                      mx: 1,
                      color: "#4d8c52",
                    }}
                  >
          ...
          <div className="row">
            <div className="col-sm">
              <div className="dropdown" id="form-crew">
                ...
                >
                  <div style={{flexDirection:"row", height:"50px",display:"flex",justifyContent:"space-between", alignItems:"center"}} >
                    <div className="col-xs">
                      <img src={office} className="custom"></img>
                    </div>
                    <div className="col">
                      <p className="form-control-name" style={{marginLeft:"10px"}} id="crew-field">
                        CREW
                      </p>
                    </div>
                    <div className="col-xs">
              ...
              <div className="dropdown" id="form-job">
                ...
                >
                  <div style={{flexDirection:"row", height:"50px",display:"flex",justifyContent:"space-between", alignItems:"center"}} >
                    ...
                    <div className="col">
                      <p className="form-control-name" style={{marginLeft:"10px"}} id="job-field">
                        JOB
                      </p>
                    </div>
                    <div className="col-xs">
        ...
        */}
        ...
        >
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                If you are constantly worried about memory overflow, divide by 0
                - this is for you.
              </li>
              <li className="career__text">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Design, develop and test (space hardened) avionics firmware that
                will support the functions of our launch vehicles and test
                systems.
              </li>
              <li className="career__text">
                Strong firmware debugging capabilities with respect to embedded
              ...
              <li className="career__text">
                Knowledgeable about serial communication protocols and ability
                to read bus traces (I2C, SPI, UART, USB, etc.).
              </li>
              <li className="career__text">
                Support through production and testing phase is expected.
              </li>
              <li className="career__text">
                Experience with a different MCUs(Cortex M4, MSP), peripherals,
          ...
          <div className="career__section">
            ...
            <ul>
              ...
              <li className="career__text">
                A minimum of 3 years of first-hand experience with Embedded
                Linux development.
              </li>
              <li className="career__text">
                A good knowledge of porting Linux kernel to various ARM-based
                SOCs, architecture, and peripherals.
              </li>
              <li className="career__text">
                Experience with Embedded Linux root file systems (Yocto,
                OpenEmbedded, Buildroot).
              </li>
              <li className="career__text">
                Experience in BSP, Linux Internals, Linux Device Driver
                Development.
              </li>
              <li className="career__text">
              ...
              <li className="career__text">
                A firm understanding of Bootloader (U-boot) and porting to
        ...
        <div className="career__description" id="erpnext-developer-desc">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                If you think, Why should people creating purchase orders and
                maintaining part inventory suffer? - this is for you.
              </li>
              <li className="career__text">
                If you think, why should engineers crafting designs not have the
                ability to quickly create work orders? - this is for you.
              </li>
              <li className="career__text">
                If you think, why should not every component have a story from
                sourcing to stores? - this is for you.
              </li>
              <li className="career__text">
                If you think, Why should not work floor crew members not be able
                to appreciate process flow from design to execution? - this is
                for you
              </li>
              <li className="career__text">
                With this in mind, we are setting out to build out our own
                software that will help us be both a research company and a
                process focussed company. If this sounds interesting, you may
                like to be one of the people writing this code!
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Create the fundamental software framework that would enable
                process implementation at Agnikul.
              </li>
              <li className="career__text">
                Detect and troubleshoot software issues.
              </li>
              <li className="career__text">
                Write clear quality code for software and applications and
                perform test reviews.
              </li>
              <li className="career__text">Develop, implement, & test APIs.</li>
              <li className="career__text">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                2+ years' of development experience with agile development
                methodologies.
              </li>
              <li className="career__text">
                Be able to understand software development life cycle, unit and
                integration system testing.
              </li>
              <li className="career__text">
                Experience with Python, Javascript, MySQL, MariaDB and Jinja
                templates.
              </li>
              <li className="career__text">
                Appreciation for all aspects of development including the server
                side, client side and API.
              </li>
            </ul>
          </div>
          <div className="career__section">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                You might have designed one of the most complex operations
        ...
        <div className="career__description" id="labview-developer-desc">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                If you think instrumentation is more important than a test
                itself - this is for you.
              </li>
              <li className="career__text">
                If you think a good GUI is one of the best tools to motivate
                testers - this is for you.
              </li>
              <li className="career__text">
                If you love enabling people control complex systems - this is
                for you.
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Design, develop and test (space hardened) avionics hardware that
                will support the functions of our launch vehicles and
                spacecraft.
              </li>
              <li className="career__text">
                Will assist with prototyping, schematic capture, debugging,
                hardware bug tracking, functional verification and signal
                characterization.
              </li>
              <li className="career__text">
                Efficiently develop complex software in the LabVIEW programming
                environment.
              </li>
              <li className="career__text">
                Accurately estimate the timelines required to develop LabVIEW
                programs.
              </li>
              <li className="career__text">
                Practice effective revision control of programs that are
                developed.
              </li>
              <li className="career__text">
                Effectively troubleshoot the systems associated with the LabVIEW
                program, including not only the software but other aspects such
                as the host PC, sensors, electrical junctions, etc.
              </li>
            </ul>
          </div>
          <div className="career__section">
          ...
          <div className="career__section">
            ...
            <ul>
              ...
              <li className="career__text">
                Minimum certification of National Instruments CLAD, Certified
                LabVIEW Developer.
              </li>
              <li className="career__text">
                Experience with laboratory instrumentation such as encoders,
                LVDTs, oscilloscopes, micrometers, and capacitive probes.
              </li>
              <li className="career__text">
                Experience with solid modeling or electrical CAD is desirable
                but not required.
              </li>
              <li className="career__text">
                2+ years of board level experience designing hardware from
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                You might have created one of the most complex ground test
                system architecture in the world.
              </li>
              <li className="career__text">
                Your work will directly impact the company's (and the rocket's)
                trajectory.
        ...
        >
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Leads the controller design and integration process for launch
                vehicle control systems and related components.
              </li>
              <li className="career__text">
                Specifically, Aid in the development of Autopilot linear
              ...
              <li className="career__text">
                Lead development and maintenance of software tools that predict
                pre-flight performance under nominal, off-nominal conditions.
              </li>
              <li className="career__text">
                Perform post flight verification of simulation predictions and
                Monte Carlo through multiple flight conditions.
              </li>
              <li className="career__text">
                Create hazards assessment programs and tools to understand
                probability of impact and expected damage from off-nominal and
                failure modes.
              </li>
              <li className="career__text">
                Support design reviews and milestones as necessary.
              ...
              <li className="career__text">
                Development of system level requirements for cross coupled
                dynamics between propellant utilization algorithms and vehicle
                guidance / autopilot algorithms.
              </li>
              <li className="career__text">
                Support design reviews and milestones as necessary.
              </li>
              ...
              <li className="career__text">
                Board level design for both ground checkout systems and flight
                hardware.
              </li>
              <li className="career__text">
                Support design reviews and milestones as necessary
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Bachelors in Electrical engineering, Electronics &
                Communications or Mechanical engineering.
              </li>
              <li className="career__text">
                Highly developed computer skills using EE design/analysis
                software.
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Masters degree in Electrical engineering, Electronics &
                Communications engineering.
              </li>
              <li className="career__text">
                2+ years experience with spacecraft ACS hardware and software
                development - ACS design, manufacture, simulation, and test.
              </li>
              <li className="career__text">
                2+ years experience with mechanical systems and engines.
              </li>
              <li className="career__text">
                Hands on experience using electrical/software test and analysis
                equipment.
              </li>
              <li className="career__text">
                Good understanding of orbital mechanics, multi-body dynamics,
              ...
              <li className="career__text">
                Experience with static constrained optimization, calculus of
                variations, dynamic optimization, maximum principle, Riccati
                equations, learning and adaptation in controllers.
              </li>
            </ul>
          </div>
          <div className="career__section">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                You might have designed one of the most challenging autopilot
        ...
        >
          ...
          <div className="career__section">
            ...
            <ul>
              ...
              <li className="career__text">
                If you are appreciative of how our brains demodulate signals
                from the high frequency noise around us - this is for you
              </li>
              <li className="career__text">
                If you have wondered why humans don't have antennae to
                communicate - this is definitely for you
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Create RF hardware specifications for the RF system and RF
                blocks
              </li>
              <li className="career__text">
                Design, debug, resolve analog/RF/mixed signal noise issues and
                RF coupling, shielding and grounding.
              </li>
              <li className="career__text">
                Simulate and model RF front-end &#38; back-end architecture and
                related systems, working with designers, Modem/DSP and ASIC
                engineers to divide functions between hardware &#38; software.
              </li>
              <li className="career__text">
                Develop RF circuits, components, board and space qualified
                packages.
              </li>
              <li className="career__text">
              ...
              <li className="career__text">
                Assist in the development of automated test equipment for lab
                measurements
              </li>
              <li className="career__text">
              ...
              <li className="career__text">
                Interaction with vendors for component sourcing, selection and
                procurement.
              </li>
              <li className="career__text">
                Defining testing, EMI/EMC, environmental qualification process
                for the RF modules based on standards.
              </li>
              <li className="career__text">
                Developing Ground based testing schemes and software for testing
                and validating the developed onboard systems.
              </li>
              <li className="career__text">
                Proper documentation of the work done for internal/external
                reviews.
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Bachelors / Master’s Degree in Electrical Engineering or similar
                discipline with focus on RF design
              </li>
              <li className="career__text">
                Strong hands on experience using RF test equipment including
                spectrum analyzer, vector network analyzer, noise figure meter,
                and impedance tuner.
              </li>
              <li className="career__text">
              ...
              <li className="career__text">
                Strong knowledge of semiconductors, analog circuits, RF design
                fundamentals, wireless systems and electromagnetics.
              </li>
              <li className="career__text">
                Understanding of RF design parameters and concepts including
                gain, noise figure, S parameters, impedance matching, harmonics,
                stability.
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                5+ years of experience in Design, Test and integration of RF
                communications system.
              </li>
              <li className="career__text">
                Strong understanding and experience in RADAR algorithm
                development, Network theory, I-Q signal processing, link budget
                estimation.
              </li>
              <li className="career__text">
                Experience in principles, Figures of merit and selection of RF
                components like Antenna, filters, RF IC, Attenuators, Mixers,
                Baluns, Duplexers, RF couplers etc.
              </li>
              <li className="career__text">
                Experience in Software defined Radios and FPGA
              </li>
              <li className="career__text">
                4+ years of experience in RF electronics debugging and testing
                with testing tools like Spectrum analyzer, Network analyzer,
              ...
              <li className="career__text">
                Ability work in fast paced, agile environment with minimal
                supervision
              </li>
            </ul>
          </div>
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                You might have designed one of the most power efficient data
                transmitters that is possible in the world today
              </li>
              <li className="career__text">
                Your work will directly impact the company's (and the rocket's)
                trajectory.
        ...
        >
          ...
          <div className="career__section">
            ...
            <ul>
              ...
              <li className="career__text">
                If you can't tolerate loosely hanging wires even in prototypes -
                this is for you.
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              ...
              <li className="career__text">
                Schematic design, generate Bill Of Materials (BOM). Be able to
                debug the PCB after fabrication.
              </li>
              <li className="career__text">
                Support through the production and testing phase is expected.
              </li>
              <li className="career__text">
                Review design guidelines to create PCB layouts including PCB
                footprints.
              </li>
              <li className="career__text">
          ...
          <div className="career__section">
            ...
            <ul>
              ...
              <li className="career__text">
                Knowledge in High-Speed Digital interfaces such as memory buses(
                eMMC, LPDDR, NAND, etc.)
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Bachelors/Masters of Science Degree in Electrical Engineering,
                Computer Engineering or equivalent area of focus.
              </li>
              <li className="career__text">
                2+ years of board level experience designing hardware from
                concept through production; strong emphasis on full lifecycle
        ...
        >
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                If you worry what goes inside of the payload fairing of a rocket
                and who makes it - this is for you
              </li>
              <li className="career__text">
                If you have wondered how to start a postcard service to space -
                this is for you
              </li>
              <li className="career__text">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Devise customer acquisition and retention strategy for a mini
                launch vehicle.
              </li>
              <li className="career__text">
                Identify need for and develop a variety of promotional and
                marketing strategy to attract new and existing payload customers
              </li>
              <li className="career__text">
                Develop resources to support, implement, and monitor effective
                marketing strategies for a company where the product can extend
                beyond just a launch vehicle and can extend into insurance
                pricing etc.
              </li>
              <li className="career__text">
                Devise plans to solve customers needs and create a feedback loop
                to the engineering and product development team
              </li>
              <li className="career__text">
                Negotiate contracts with clients including MoUs, Letter of
                Intent and launch contracts
              </li>
              <li className="career__text">
                Lead marketing campaigns and promotional events
              </li>
              <li className="career__text">
                Compile customer research and market analysis and devise
                customized competitive deals based on both quantitative models
                and market intuition
              </li>
              <li className="career__text">
                Responsible for maintaining and re-inventing customer
                relationship management (CRM) system in a mini launch vehicle
                company
              </li>
              <li className="career__text">
                Responsible for spearheading complex deals that involves
                government, regulatory bodies and space agencies
              </li>
            </ul>
          </div>
          <div className="career__section">
            <p className="career__head">BASIC QUALIFICATIONS</p>
            <ul>
              <li className="career__text">Bachelor's Degree</li>
              <li className="career__text">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Your work will directly impact the company's as well as the
                ecosystem for launch vehicles
              </li>
              <li className="career__text">
                You will learn rocket science from some of the most senior and
                respected minds in ISRO.
        ...
        >
          ...
          <div className="career__section">
            ...
            <ul>
              ...
              <li className="career__text">
                If you have wondered why Apple outsources its manufacturing
                outside USA - this is for you
              </li>
              <li className="career__text">
                If you understand Lead and Lean in a same sentence - this is for
                you
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              ...
              <li className="career__text">
                Develop launch vehicle optimization problem solutions by
                describing requirements in a work-flowchart and diagram;
                studying system capabilities; analyzing alternative solutions;
                preparing system specifications; writing programs.
              </li>
              <li className="career__text">
                Develop project estimates by identifying phases and elements,
                personnel requirements, and costs.
              </li>
              <li className="career__text">
                Enhance operations through systems thinking by researching and
                resolving day-to-day operational demands of the company
              </li>
              <li className="career__text">
                Prepare launch vehicle survey reports by collecting, analyzing,
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">Bachelor's Degree</li>
              <li className="career__text">Problem Solving</li>
              <li className="career__text">Quality Focus</li>
              <li className="career__text">Cross Cultural Negotiations</li>
            </ul>
          </div>
          <div className="career__section">
            <p className="career__head">PREFERRED SKILLS AND EXPERIENCE</p>
            <ul>
              ...
              <li className="career__text">
                General Consulting Skills, Project Management, Process
                Improvement, Client Relationships, Reporting Skills, Networking
                Knowledge, Networking Standards, Technical Zeal, Job Knowledge
              </li>
            </ul>
          </div>
          <div className="career__section">
        ...
        <div className="career__description" id="launch-vehicle-economist-desc">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                If you know how a launch vehicle could affect GDP - this is for
                you
              </li>
              <li className="career__text">
              ...
              <li className="career__text">
                If you understand money value of time ( &amp; time value of
                money, of course) - this is for you
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Perform financial analysis of launch vehicle costing and
                strategize financial planning based on forecasted business needs
                and targets
              </li>
              <li className="career__text">
                Analyze launch vehicle pricing data using mathematical models
                and statistical techniques
              </li>
              <li className="career__text">
                Prepare budgets &amp; submit recommendations for the approval or
                disapproval of funds requests.
              </li>
              <li className="career__text">
                Create and be part of AgniKul’s financial model that creates
                efficient cash flow and increases profits.
              </li>
              <li className="career__text">
                Examine pricing and supply-demand estimates for completeness,
                accuracy, and conformance with procedures and regulations.
              </li>
              <li className="career__text">
                Perform cost-benefits analysis to compare operating programs,
                review financial requests, and explore alternative financing
                methods.
              </li>
              <li className="career__text">
                Create a supply chain curve and work along side the Operations
                strategist to map out the economics of rocket making.
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">Bachelor's Degree.</li>
              <li className="career__text">Cost and budget planning skills.</li>
              <li className="career__text">
              ...
              <li className="career__text">Business ethics.</li>
            </ul>
          </div>
          <div className="career__section">
            <p className="career__head">PREFERRED SKILLS AND EXPERIENCE</p>
            <ul>
              ...
              <li className="career__text">
                Building strategic partnerships and facilitating the development
                of collaborative relationships.
              </li>
              <li className="career__text">
                Understanding of principles and trends within the economic
        ...
        >
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                If you like to understand how to cost a launch vehicle - this is
                for you
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                ...
                compiling and understanding account information.
              </li>
              <li className="career__text">
                Document financial transactions by documenting account
                information.
              </li>
              <li className="career__text">
                Recommend financial actions by understanding accounting
                alternatives.
              </li>
              <li className="career__text">
                Summarize financial status by gathering information; creating
                balance sheet, profit and loss statement, and other reports.
              </li>
              <li className="career__text">
                Maintain controls by preparing and recommending policies and
                procedures.
              </li>
              <li className="career__text">
                Reconcile / tally financial discrepancies by gathering and
              ...
              <li className="career__text">
                Answer accounting questions by researching and understanding
        ...
        >
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                If you love dealing with engineers, programmers, lawyers and
                finance professionals on the same day at the same time, this is
                for you.
              </li>
              <li className="career__text">
                If you are believe that good teams build great products, this is
                for you
              </li>
              <li className="career__text">
                If you believe in shaping the people behind a product, this is
                for you.
              </li>
            </ul>
          </div>
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Provide careful direction and guidance on multi-layer employee
                relations issues, company structure, crew planning, crew
                engagement, dynamics management, and other human capital
                initiatives.
              </li>
              <li className="career__text">
                Mentor and coach leadership through delivery and product
                management issues and help them enhance their leadership skills.
              </li>
              <li className="career__text">
                Use meaningful data to identify patterns and areas of question,
                to monitor direction of remedial actions.
              </li>
              <li className="career__text">
                Manage and help enforce legal compliance with relevant laws and
                company guidelines and policies.
              </li>
              <li className="career__text">
                Support dynamics and change management to introduce innovative
                and impactful HR initiatives and changes, often working in close
                partnership with co founders.
              </li>
              <li className="career__text">
                Design and rapidly execute solutions, guidelines, or approaches
                that cut across all crews and stakeholders to achieve company
                vision without sacrificing compliance or company culture.
              </li>
            </ul>
          </div>
          <div className="career__section">
            <p className="career__head">BASIC QUALIFICATIONS</p>
            <ul>
              <li className="career__text">Bachelor Degree.</li>
              <li className="career__text">
          ...
          <div className="career__section">
            ...
            <ul>
              <li className="career__text">
                Passion for human capital, professional relationship management
                and understanding natural people behaviour.
              </li>
              <li className="career__text">
              ...
              <li className="career__text">
                Prior experience working with people from all strata of
                educational qualifications cutting across educational streams
                and geographic boundaries.
              </li>
              <li className="career__text">
                Excellent interpersonal skills and the ability to demonstrate
                empathy.
              </li>
              <li className="career__text">
                Comfortable pushing back on senior leadership and challenging
                the status quo.
              </li>
              <li className="career__text">

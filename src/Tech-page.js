...
import agnilet from './images/tech/agnilet.jpg';
/*import testing from './images/tech/pressure.png';*/
import shop from "./images/products/shopWhite.svg";
import testing from './images/tech/enginefiring.jpg';
import copv from './images/tech/COPV.png';
import avionics from './images/tech/Avionics.jpeg'
import launchpad from './images/tech/launchpad.jpeg'
import threeDPrint from './images/tech/threeDPrint.jpeg'
...
var techContents = [
  {
    heading: "Hot Fire Testing",
    text: (
      <div>
        Realizing a semi cryogenic engine is one thing. 
        Firing it is another. We have been firing engines since September 2018 - you can look at some of those videos {" "}
        <a
  ...
  {
    heading: "Agnilet - A single piece, 3D printed, semi cryogenic engine.",
    text: (
      <div>
        Our Agnilet engine is unique. It is entirely 3D printed and in one
        piece. 1000’s of parts have been carefully designed to be captured in
        this one piece of hardware. It is capable of about 3kN of thrust at sea
        level and drives our Agnibaan’s higher stage. 3d printing is magic! If
        you want to learn more about this, please check out our{" "}
        <a
          href="https://medium.com/agnikuls-blog/what-really-is-a-single-piece-rocket-engine-why-we-make-these-at-agnikul-part-1-n-285252bcbc73"
          target="blank"
        >
          blog
        </a>
  ...
  },
  {
    ...
    text: (
      <div>
        Our stages have liquid propellants & pressurants to be stored at high
        pressures. So, we have figured out unique designs, material choices and
        adhesives to wrap our pressure vessels with fiber that will allow thin
        walled tanks to hold these enormous pressures. While the technology
        itself is not new to the industry, we have not seen anyone do it the way
        we do it - in a fraction of the time, at a fraction of the cost.
      </div>
    ),
    image: copv,
  },
  {
    ...
    text: (
      <div>
       We use 3D printing extensively to manufacture the critical parts of Agnibaan such as engines, pumps, motor casings and package casing. The parts are being manufactured at our own facility called Agnikul Rocket Factory - 1. The facility has the ability to produce two rocket engines every week which could enable the production of one launch vehicle every month.
      </div>
    ),
    image: threeDPrint,
  },
  {
    ...
    text: (
      <div>
      Agnikul has established India's first private launchpad at ISRO's most commonly used launchpad (Sriharikota). This enables our customers to have access to one additional spaceport in India.
      </div>
    ),
    image: launchpad,
  },
  {
    ...
    text: (
      <div>
        Our Agnibaan is powered by onboard computers and avionics packages developed in-house.
      </div>
    ),
    image: avionics,
  },
...
class Home extends React.Component {
  ...
  render() {
      ...
      var techs = techContents.map((techContent,index) => {
          ...
          return (
              <div className={index % 2 == 0 ? "row tech__row" : "row tech__row tech__row__reverse"}>
                  {section}
                  {image}
              </div>
          )
    ...
    return (
      <div className="body">
        ...
        {/*********************************HEADING***********************************************************************/}
        <p className="tech__section-head">Engineering</p>
        <p className="tech__section-head-text">
          Engineering is at the heart of what we want to deliver to our
          customers. You can read about some of our hardware / software here.
        </p>
        {/* ****************** TECHS ******************************************** */}

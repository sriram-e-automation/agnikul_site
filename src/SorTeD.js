...
var techContents = [
  {
    ...
    text: (
      <div>
        Single-stage rocket powered by Agnilet semi-cryogenic engine. 
        Unlike traditional sounding rockets that launch from guide rails, 
        Agnibaan SOrTeD will lift off vertically and follow a predetermined trajectory while performing 
        a precisely orchestrated set of manoeuvres during flight. {" "}
  ...
  },
  {
    ...
    text: (
      <div>
        One of the systems that differentiates a engine ground test fire from actual flight
         is the autopilot. We have characterised the gimbaling system using which the autopilot
          rotates the thrust at our own in-loop facility.
      </div>
    ),
    image: enginegimble,
  },
  {
    ...
    text: (
     ...
     The mission control room is designed based on the rehearsals that we
      performed in a stand-alone setup which replicates our mission control room at SDSC SHAR.
      </div>
    ),
    image: mcrc,
  },
  {
    ...
    text: (
      <div>
    We have setup our own mission control centre at SDSC SHAR to carry out remote operations at Agnikul launchpad.
      </div>
    ),
    image: mcr,
  },
  ...
  render() {
    ...
    return (
      <div className="body">
        ...
        {/*********************************HEADING***********************************************************************/}
        <p className="tech__section-head"><span style={{color:"#4d8c52"}}>S</span>ub<span style={{color:"#4d8c52"}}>Or</span>bital <span style={{color:"#4d8c52"}}>Te</span>chnological <span style={{color:"#4d8c52"}}>D</span>emonstrator (SOrTeD)</p>
